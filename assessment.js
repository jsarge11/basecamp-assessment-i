...
var me = 'My name is ' + myName + ' and my favorite number is ' + '11';
...
/*------------------------------I made it so it passed the tests, but I feel like the requirement described in this folder is different than the test------------------------------*/
